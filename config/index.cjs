...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx5aa31f46cc6d4a5b',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '2753e6e6dd827b9d4cf6e280077a5300',
  ...
  USERS: [
    {
      ...
      id: 'omlqp6KPRnSQFE-LmGolgc_3RaS4',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'HJ-rpduulvM-qW9sJ4K2PW5hIzn3p0juimm13IHl5Uk',
      // 所在省份
      province: '河南',
      // 所在城市
      city: '焦作',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '2002', date: '07-20',
        },
        {
          type: '节日', name: '结婚纪念日', year: '2022', date: '01-18',
        },
